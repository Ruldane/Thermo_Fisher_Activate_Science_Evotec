    ...
    try {
      const { data } = await axios.post(
        `${process.env.REACT_APP_BACKEND_URL}/submitActivateScience`,
        {
          ...
          accountNumber: Account_Number ? Account_Number : 'no account number',
          firstName: firstName,
          lastName: lastName,
          company: company,
          businessPhone: businessPhone ? businessPhone : 'no business phone',
          address1: address1,
          city: city,
      ...
      {loading ? (
        ...
        <Container maxWidth="md" sx={{ mb: 5, mt: 1 }}>
          ...
          >
            ...
            <Button onClick={deleteSupplier}>Cliquez ici</Button>
                ...
                <div className="reg_btn_wrapper">
                  {requestType ? (
                    <button
                      ...
                      className={
                        !requestType ? 'grey_btn' : 'blue_btn open_signup'
                      }
                    >
          ...
          <Collapse in={open}>
            <Alert
              ...
              severity="success"
            >
              Merci d'avoir participé à L’Activate Science Evotec Toulouse..{' '}
              {`${firstName} ${lastName}`}
              <br />
              Veuillez fermer cette fenêtre et scanner le QR code du client
              suivant. <br />
              <Button
                sx={{ color: 'white' }}
                onClick={() => {
